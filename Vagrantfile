...
Vagrant.configure("2") do |config|
    config.vm.define "workshop" do |workshop|
      ...
      if File.exists?(File.expand_path("C:/Users/yicle/Coding Projects/pubkey_priv.ppk"))
        workshop.vm.provision "file", source: "C:/Users/yicle/Coding Projects/pubkey_priv.ppk", destination: "C:/Users/yicle/Coding Projects/pubkey_priv.ppk"
      end
